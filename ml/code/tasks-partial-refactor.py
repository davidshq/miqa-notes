...
# In addition, this refactor:
#   removes debugging lines,
#   renames model_to_frames_map to model_to_frames_dict
#   renames current_model to eval_model
...
def evaluate_data(frames_by_project):
    ...
    for project_id, frame_ids in frames_by_project.items():
        ...
        for frame_id in frame_ids:
            ...
            if Path(file_path).exists():
                ...
                if eval_model_name not in model_to_frames_dict:
                    model_to_frames_dict[eval_model_name] = []
                # Add the frame to the list for the eval_model_name value.
                model_to_frames_dict[eval_model_name].append(frame)
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        for model_name, frame_set in model_to_frames_dict.items():
            # Get the PyTorch model file name
            ...
            results = evaluate_many(eval_model, list(file_paths.values()))
